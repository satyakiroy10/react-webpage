  ...
  return (
    <section id="Footer" className="footer--section">
        ...
        <div className="footer--link--container">
            ...
            <p className="footer--content">Thank you for visiting :)</p>
            </div>
            <ul>
                <li>
                <a
                    href="https://www.instagram.com/satyaki_rc/"
                ...
                <li>
                <a
                    href="https://www.linkedin.com/in/satyaki-roy-chowdhury/"
                    className="navbar--content"
                    target="_blank"
                    rel="noreferrer"
                >
        ...
        <div className="footer--content--container-1">
            <p className="footer--content">Phone: +1(650)661 9011</p>
            <p className="footer--content">Email: chowdhury.207@osu.edu</p>
        </div>
        </footer>
    </section>
  );
        ...
        <footer className="footer--container">
          <div className="footer--link--container">
            <div className="footer--social--icon" style={{ textAlign: 'center' }}>
              <div className="footer--content--container" style={{ textAlign: 'center' }}>
                <p className="footer--content--1" style={{ fontSize: '1.6rem', marginBottom: '20px' }}>Thank you for visiting :)</p>
              </div>
          ...
          <div className="footer--content--container-1">
            <p className="footer--content-1" style={{ fontSize: '1.2rem'}}>Phone: +1(650)661 9011</p>
            <p className="footer--content-1" style={{ fontSize: '1.2rem'}}>Email: chowdhury.207@osu.edu</p>
            <br />
            <p className="footer--content-1" style={{ fontSize: '1.2rem'}}>&copy;  2024 by Satyaki Roy Chowdhury. All rights reserved.</p>
          </div>
        </footer>
      </section>
    );
